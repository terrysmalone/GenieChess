...
namespace ChessEngine.BoardRepresentation
{
    ...
    public class Board 
    {
        ...
        public void PlacePiece(PieceType typeToPlace, bool pieceIsWhite, int positionToPlace)
        {
        ...
        internal void PlacePiece(PieceType typeToPlace, bool pieceIsWhite, ulong squareToPlace)
        {
            switch (typeToPlace)
            {
                case (PieceType.Pawn):
